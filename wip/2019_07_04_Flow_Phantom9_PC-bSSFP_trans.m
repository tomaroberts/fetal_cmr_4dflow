...
save('../FP9_bSSFP_trans.mat','VEL','M');
...
templateNii = 'ax_mag_trans.nii.gz';
...
nii.img = VEL.rl;
save_nii(nii,'rl_vel_trans.nii.gz');
nii.img = VEL.ap;
save_nii(nii,'ap_vel_trans.nii.gz');
nii.img = -1 .* VEL.fh; %%% IMPORTANT FOR MRtrix - must flip z/fh direction
save_nii(nii,'fh_vel_trans.nii.gz');
