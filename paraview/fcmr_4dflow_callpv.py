...
print('Entered fcmr_4dflow_callpv.py ... ')
...
# magnitude_intensityLUT.RGBPoints = [-7.28000020980835, 0.0, 0.0, 0.0, 87.65499806404114, 0.0, 0.0, 0.0,
#                                     182.58999633789062, 1.0, 1.0, 1.0]
...
# magnitude_intensityPWF.Points = [-7.28000020980835, 0.0, 0.5, 0.0, 87.65499806404114, 0.0, 0.5, 0.0, 182.58999633789062,
#                                  1.0, 0.5, 0.0]
...
# velocity_magnitudeLUT.RGBPoints = [0.0, 0.231373, 0.298039, 0.752941, 11.645000457763672, 0.865003, 0.865003, 0.865003,
#                                    23.290000915527344, 0.705882, 0.0156863, 0.14902]
...
# velocity_magnitudeLUT.RescaleTransferFunction(0.0, 60.0)
#
...
# SaveState(path + pvStateFilename)