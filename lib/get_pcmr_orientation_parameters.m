...
varArray = { 'str', 'flow1', 'flow2', 'ori_x', 'ori_y', 'ori_z', 'dur', 'slope1', 'slope2', 'time', 'ref' }; 
...
for oo = 1:numel(objectArray)
    ...
    structNameArray = { [structNames{oo} '_str'],  ...
                        ...
                        [structNames{oo} '_ori_z'], ...
                        [structNames{oo} '_dur'], ...
                        [structNames{oo} '_slope1'], ...
                        [structNames{oo} '_slope2'], ...
                        [structNames{oo} '_time'], ...
                        [structNames{oo} '_ref'] }; % variables to collect from object
...
%% Phase gradient objects

% Collect variables from objects
objectArray = { 'GR `py' };
structNames = { 'py' }; %strings in objectArray incompatiable with MATLAB structures
